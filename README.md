...
Semantic HTML uses meaning to structure the data on the page.

2. Name two big differences between ```display: block;``` and ```display: inline;```.

display block takes up a whole line and display inline displays an item in place. display inline only takes up as much width as its content and block takes up as much width as it can on the page.
...
git helps multiple people have chronological access to all shared versions of a project.
